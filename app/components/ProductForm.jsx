...
export function ProductForm({
  ...
  const [isDescriptionAccordionOpen, setIsDescriptionAccordionOpen] =
    useState(true);
    ...
    <div className="product-form mt-[8px]">
      {productOptions.map((option) => {
        ...
        return (
          <div className="product-options pt-[16px]" key={option.name}>
            <h5 className="text-[14px] font-[700] mb-[20px]">{option.name}</h5>
                      ...
                      className={`cursor-pointer product-options-item
                        ...
                        ${
                          selected && swatch?.color
                            ? 'outline outline-2 outline-black outline-offset-3'
                            : ''
                        }
                      `}
                      key={option.name + name}
      ...
      <div className="border-t border-[#C4BFC1] mt-[16px] pt-[16px]">
        ...
        >
          ...
          <svg
            className={`w-[16px] h-[16px] transition-transform ${
              isReviewsAccordionOpen ? 'rotate-180' : ''
            }`}
            viewBox="0 0 12 12"
            fill="none"
          >
        ...
        <div
          className={`overflow-hidden transition-all ${
            isReviewsAccordionOpen ? 'max-h-[500px]' : 'max-h-0'
          }`}
        >
      ...
      <div className="border-t border-[#C4BFC1] mt-[16px] pt-[16px]">
        <button
          className="w-full flex justify-between items-center pb-[10px] cursor-pointer"
          onClick={() =>
            setIsDescriptionAccordionOpen(!isDescriptionAccordionOpen)
          }
        >
          ...
          <svg
            className={`w-[16px] h-[16px] transition-transform ${
              isDescriptionAccordionOpen ? 'rotate-180' : ''
            }`}
            viewBox="0 0 12 12"
            fill="none"
          >
        ...
        <div
          className={`overflow-hidden transition-all ${
            isDescriptionAccordionOpen ? 'max-h-[500px]' : 'max-h-0'
          }`}
        >
