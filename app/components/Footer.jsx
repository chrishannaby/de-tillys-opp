      ...
      <Await resolve={footerPromise}>
        {(footer) => (
          <div className='mt-[50px]'>
            {/* Main */}
            <div className='pt-[60px] pb-[30px] bg-[#f5f5f5]'>
              <div className='container mx-auto flex justify-between'>
                ...
                <div className='flex flex-col gap-[15px]'>
                  ...
                  {footer?.forYouMenu?.items?.map((item) => (
                    <Link 
                      key={item.id}
                      to={item.url}
                    >
                ...
                <div className='flex flex-col gap-[15px]'>
                  ...
                  {footer?.guestServicesMenu?.items?.map((item) => (
                    <Link 
                      key={item.id}
                      to={item.url}
                    >
                ...
                <div className='flex flex-col gap-[15px]'>
                  ...
                  {footer?.companyMenu?.items?.map((item) => (
                    <Link 
                      key={item.id}
                      to={item.url}
                    >
                ...
                <div className='flex flex-col max-w-[344px]'>
                  <h2 className='text-[16px] font-bold mb-[12px]'>
                    Find a Store
                  </h2>
                  ...
                  <input 
                    ...
                    className='py-[12px] px-[16px] rounded-[8px] text-[16px] bg-white border border-[gray] mb-[16px]'
                  />

                  <button
                    type="button"
                    className='cursor-pointer bg-black text-white px-[16px] py-[13px] rounded-[8px] w-fit mb-[16px] transition-all duration-200 ease-out hover:bg-[#757575] hover:border-[#757575] hover:text-white hover:no-underline'
                  >
                    Search
                  </button>

                  <h2 className='text-[16px] font-bold mb-[16px]'>
                  ...
                  <input 
                    ...
                    className='py-[12px] px-[16px] rounded-[8px] text-[16px] bg-white border border-[gray] mb-[32px]'
                  />
                  ...
                  <p className='text-[11px] mb-[16px]'>
                    Yes, I agree to receive promotional texts from Tillys at the number provided above. Consent is not a condition of purchase. You can opt-out any time by replying STOP. Message & data rates may apply. Message frequency will vary and messages may be sent by autodialer. You also consent to our <a className='underline text-[#205263]'>Privacy Policy</a> and <a className='underline text-[#205263]'>Terms of Use</a>
                  </p>

                  <button
                    type="button"
                    className='cursor-pointer bg-black text-white px-[16px] py-[13px] rounded-[8px] w-fit transition-all duration-200 ease-out hover:bg-[#757575] hover:border-[#757575] hover:text-white hover:no-underline'
                  >
                    Sign Up
                  </button>
